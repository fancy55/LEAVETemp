...
public class RsaUtil {
    //加密 qly
    public static String enPass(String str, int start, int end) throws Exception {
        byte[] ciphertext = encryptByPublicKey(str.getBytes(), getPublicKey());//公钥加密
        return Base64.encodeBase64String(ciphertext).substring(start, end); //公钥加密后
    }
